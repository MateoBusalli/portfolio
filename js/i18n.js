...
const translations = {
    en: {
        ...
        demoSubtitle: 'Select a case file to open',
        demoBruteTab: 'Bruteforce',
        demoBruteTitle: 'Bruteforce & Subdomain Scanner',
        demoTermRun: '▶ RUN SIMULATION',
        demoTermClear: '✕ CLEAR',
        demoRailChart1: 'Average delay by line (minutes)',
        demoRailChart2: 'Delay frequency by cause (%)',
        demoRailNote: '* Illustrative data // real tool uses SNCF open dataset + Navitia real-time API',
        demoDbTitle: 'Parcoursup SQL Database',
        demoDbRows: 'Records',
        demoDbCols: 'Columns',
        demoDbYear: 'Year',
        demoDbFormats: 'Formats (xlsx→csv→sql)',
        demoDbColFormation: 'Formation',
        demoDbColField: 'Field',
        demoDbColAccess: 'Access rate',
        demoDbColCandidates: 'Candidates',
        demoTodoAdd: '+ ADD',
        demoTodoEmpty: '// No tasks yet',

        // HR Page
        hrPageTitle: 'HR // Recruiter Page',
        hrStatus: 'Status',
        hrStatusVal: 'In internship',
        hrAvailability: 'Availability',
        hrAvailabilityVal: 'End of 2026',
        hrDuration: 'Duration',
        hrDurationVal: '6 months',
        hrLocation: 'Location',
        hrContractTitle: 'Contract Details',
        hrContractType: 'Contract type',
        hrContractTypeVal: 'Internship / Apprenticeship',
        hrStartDate: 'Start date',
        hrStartDateVal: 'End of 2026',
        hrDurationLabel: 'Duration',
        hrMobility: 'Mobility',
        ...
        hrStrength3Label: 'Languages',
        hrSkillAutonomous: 'Autonomous',
        hrSkillCurious: 'Curious',
        hrSkillRigorous: 'Rigorous',
        hrSkillTeamwork: 'Team player',
        hrLangFR: 'French (native)',
        hrLangEN: 'English (B1+)',
        ...
        demosCard: 'Project Demos',
        demosDesc: 'Interactive demos and technical showcases',
        hrCard: 'Recruiter Page',
        hrDesc: 'Dedicated space for HR and recruiters',
    ...
    fr: {
        ...
        demoSubtitle: 'Sélectionnez un dossier à ouvrir',
        demoBruteTab: 'Bruteforce',
        demoBruteTitle: 'Scanner Bruteforce & Sous-domaines',
        demoTermRun: '▶ LANCER LA SIMULATION',
        demoTermClear: '✕ EFFACER',
        demoRailChart1: 'Retard moyen par ligne (minutes)',
        demoRailChart2: 'Fréquence des retards par cause (%)',
        demoRailNote: '* Données illustratives // l\'outil analyse de vrais exports SNCF + API Navitia temps réel',
        demoDbTitle: 'Base de données SQL Parcoursup',
        demoDbRows: 'Enregistrements',
        demoDbCols: 'Colonnes',
        demoDbYear: 'Année',
        demoDbFormats: 'Formats (xlsx→csv→sql)',
        demoDbColFormation: 'Formation',
        demoDbColField: 'Filière',
        demoDbColAccess: 'Taux d\'accès',
        demoDbColCandidates: 'Candidats',
        demoTodoAdd: '+ AJOUTER',
        demoTodoEmpty: '// Aucune tâche pour l\'instant',

        // Page RH
        hrPageTitle: 'RH - Page Recruteur',
        hrStatus: 'Statut',
        hrStatusVal: 'Stage',
        hrAvailability: 'Disponibilité',
        hrStatusVal: 'En stage',
        hrAvailability: 'Disponibilité',
        hrAvailabilityVal: 'Fin 2026',
        hrDuration: 'Durée',
        hrDurationVal: '6 mois',
        hrLocation: 'Localisation',
        hrContractTitle: 'Détails du Contrat',
        hrContractType: 'Type de contrat',
        hrContractTypeVal: 'Stage / Alternance',
        hrStartDate: 'Date de début',
        hrStartDateVal: 'Fin 2026',
        hrDurationLabel: 'Durée',
        hrMobility: 'Mobilité',
        ...
        hrStrength3Label: 'Langues',
        hrSkillAutonomous: 'Autonome',
        hrSkillCurious: 'Curieux',
        hrSkillRigorous: 'Rigoureux',
        hrSkillTeamwork: 'Esprit d\'équipe',
        hrLangFR: 'Français (natif)',
        hrLangEN: 'Anglais (B1+)',
        hrDocsTitle: 'Documents',
        ...
        demosCard: 'Démos de Projets',
        demosDesc: 'Démos interactifs et vitrines techniques',
        hrCard: 'Page Recruteur',
        hrDesc: 'Espace dédié aux RH et recruteurs',
